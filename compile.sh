...
g++ -O3 -Iinclude -Ithirdparty/popstationmdg/src/plugins/ -Ithirdparty/popstationmdg/src/logger/ -std=c++17 -ffunction-sections -fPIC -g -static-libgcc -static-libstdc++ -shared thirdparty/popstationmdg/src/logger/logger.cpp src/iso_common.cpp src/iso_reader.cpp src/iso_writer.cpp -o bin/linux/iso_reader.so
