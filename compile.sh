...
x86_64-w64-mingw32-g++ -g -Iinclude -Ithirdparty/popstationmdg/src/plugins/ -std=c++17 -fPIC -DBUILD_LIB -shared -static-libgcc -static-libstdc++ thirdparty/popstationmdg/src/plugins/export.cpp src/reader/iso_reader.cpp -o bin/windows/iso_reader.dll
